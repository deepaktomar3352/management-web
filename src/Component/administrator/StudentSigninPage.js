...
export default function StudentSigninPage() {
    ...
    // const studentname = name.map(item=>item.student_name)
    // console.log("name",studentname)

    // const handleName = async () => {
    //     var body = { emailaddress: EmailAddress, password: Password }
    //     var result = await postData('admin/studentchkadminlogin', body)
    //     setName(result.data)
    // }
                            ...
                            <div className="card-body p-md-5">
                                <div className="row justify-content-center">
                                    <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1" style={{ display: "flex", justifyContent: "center", flexDirection: "column" }}>
                                        ...
                                        <p className="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4" style={{ fontFamily: "serif" }}>Student SignIn </p>
