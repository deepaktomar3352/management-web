...
import ChessVideo from "./Videos/ChessVideo.mp4";
      ...
      {loading ? (
        ...
        <>
          <div className="main">
            <div
              className="overlay"
              style={{ height: !matches ? "100vh" : "75vh" }}
            ></div>
            <video src={ChessVideo} autoPlay loop muted />
            <div className="content">
              {/* <h1 className="v-heading3">ilay</h1> */}
              <h1 className="v-heading">Welcome In Chess</h1>
            ...
            >
              <Grid container spacing={2} xs={12} style={{ display: "flex" }}>
                <div style={{ display: "flex", flexWrap: "wrap" }}>
                  ...
                  <Grid xs={!matches ? 6 : 12}>
                    ...
                    <div className="aboutp">
                      ...
                      in mind that the gap between the stools will be 20cm or
                      more than that.Then load will be applid upside down with
                      the help of the iron treads which will be tied at the four
                      side of the truss by making along loop and another side
                      there will be a flat wooden board where the load will be
                      placed. Truss which can bear the more loads without
                      failing will be declared as the winner of the competition.
                    </div>
                  </Grid>
                </div>
                ...
                <Grid item xs={!matches ? 6 : 12}>
                  ...
                  >
                    <div className={classes.eventCard}>Detail</div>
