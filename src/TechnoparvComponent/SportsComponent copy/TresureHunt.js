...
import TresureHuntVideo from "./Videos/TresureHuntVideo.mp4";
        ...
        <div id="TresureHunt">
             {
                loading ?
                    ...
                    : <>
            <div className='main'>
                <div className='overlay' style={{ height: !matches ? "100vh" : "75vh" }}></div>
                <video src={TresureHuntVideo} autoPlay loop muted />
                <div className='content'>
                    {/* <h1 className="v-heading3">ilay</h1> */}
                    <h1 className="v-heading">Welcome In Tresure Hunt</h1>
                    ...
                    <Grid container spacing={2} xs={12} style={{ display: "flex" }}>
                        <div style={{ display: "flex", flexWrap: "wrap" }}>
                            ...
                            <Grid xs={!matches ? 6 : 12}>
                                <h2 style={{ fontFamily: "sans-serif", margin: "5%", color: "darkgreen" }}>Tresure Hunt</h2>
