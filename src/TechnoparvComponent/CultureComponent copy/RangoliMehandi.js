...
export default function RangoliMehandi() {
        ...
        <div id="ArmWrestling">
             <div className='main'>
                ...
                <div className='content'>
                    ...
                    <h1 className="v-heading">Welcome In Rangoli Mehandi</h1>
                    ...
                    <Grid container spacing={2} xs={12} style={{display:"flex"}}>
                        <div style={{ display: "flex", flexWrap: "wrap" }}>
                            ...
                            <Grid xs={!matches?6:12}>
                                <h2 style={{fontFamily:"sans-serif",margin:"5%",color:"darkgreen"}}>Rangoli Mehandi</h2>
