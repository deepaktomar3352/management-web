...
import PaintingVideo from "./videos/Painting.mp4"
    ...
    return (
        ...
        <div id="ArmWrestling">
             <div className='main'>
                ...
                <video src={PaintingVideo} autoPlay loop muted />
                <div className='content'>
                    {/* <h1 className="v-heading3">ilay</h1> */}
                    <h1 className="v-heading">Welcome In Painting</h1>
                    ...
                    <Grid container spacing={2} xs={12} style={{display:"flex"}}>
                        <div style={{ display: "flex", flexWrap: "wrap" }}>
                            ...
                            <Grid xs={!matches?6:12}>
                                <h2 style={{fontFamily:"sans-serif",margin:"5%",color:"darkgreen"}}>On the Spot Painting</h2>
