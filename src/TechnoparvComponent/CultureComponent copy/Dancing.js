    ...
    return (
        <div id="Dancing">
             <div className='main'>
                ...
                <video src={DancingVideo} autoPlay loop muted />
                <div className='content'>
                    {/* <h1 className="v-heading3">ilay</h1> */}
                    <h1 className="v-heading">Welcome In Dancing</h1>
                    ...
                    <Grid container spacing={2} xs={12} style={{display:"flex"}}>
                        <div style={{ display: "flex", flexWrap: "wrap" }}>
                            ...
                            <Grid xs={!matches?6:12}>
                                <h2 style={{fontFamily:"sans-serif",margin:"5%",color:"darkgreen"}}>Dancing</h2>
